...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{yes-carla-can/data/etapa3_analysis/message_counts_by_id.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{yes-carla-can/data/etapa3_analysis/mean_period_by_id.png}
