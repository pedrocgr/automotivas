...
cen\'ario n\~ao continha ataque, esses alertas correspondem a falsos positivos. Ap\'os a
melhoria, o detector n\~ao gerou alertas no cen\'ario normal, indicando que a
normaliza\c{c}\~ao dos IDs CAN eliminou essa fonte de erro.
